...
export function clearStorageAndCookies(keepKeys = []) {
  // Clear sessionStorage except keepKeys
  ...
  // Clear localStorage except keepKeys
  ...
  // Clear cookies except keepKeys
  document.cookie.split(";").forEach(cookie => {
    const cookieName = cookie.split("=")[0].trim();
    if (!keepKeys.includes(cookieName)) {
