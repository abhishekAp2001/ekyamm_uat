    ...
    <div className="bg-gradient-to-t from-[#fce8e5] to-[#eeecfb] h-screen flex flex-col max-w-[576px] mx-auto">
        ...
        <div className="bg-[#FFFFFF]  p-6 pb-1 mt-[55px] rounded-[16px]">
            ...
            <Drawer className="pt-[9.97px]">
              <DrawerTrigger className="">
                <Image
                  ...
                  width={31}
                  height={31}
                  className="w-[31px] h-fit absolute bottom-[2px] right-[33%]"
                  alt="camera"
                />
              </DrawerTrigger>
          ...
          {[
            ...
            <div key={idx} className="mb-4">
              <div
                className="bg-gradient-to-r from-[#BBA3E433] to-[#EDA19733] rounded-[8px] p-2 h-[56px] pt-[16px] cursor-pointer"
                onClick={() => toggleSection(idx)}
              >
                <div className="flex justify-between items-center">
                  <span
                    className={`flex text-[14px] ${
                      item.bold ? "font-[600]" : "font-[600]"
                    } text-[#000000] ml-1 items-center`}
                  >
                    <Image
                      src={item.icon}
                      width={24}
              ...
              {activeIndex === idx && (
                <div
                  id={`scrollable-section-${idx}`}
                  className="bg-[#fff] rounded-xl shadow mt-3 max-h-[220px] overflow-y-auto px-3 py-3"
                >
                  <p className="text-[14px] font-[600] text-black mb-2">
                    Past Sessions
                  </p>
                  <div className="space-y-2">
                    {sessionData.map((session, i) => (
                      <div
                        key={i}
                        className="bg-gradient-to-r from-[#F5F2FF] to-[#FFEFEF] rounded-lg px-3 py-1 flex gap-8"
                      >
                        <div className="flex flex-col text-[12px] font-[500] text-gray-500 items-center pt-2">
                          <span>{session.date}</span>
                          <div className="flex flex-col text-[13px] font-[600] text-black items-center">
      ...
      <div className="flex flex-col justify-center items-center ">
        ...
        <div className="flex justify-center items-center mb-[26px]">
          ...
          <Image src="/images/chat_icon.png" width={67} height={26} alt="chat"  className="mt-1"/>
        </div>
      </div>
    </div>
  );
