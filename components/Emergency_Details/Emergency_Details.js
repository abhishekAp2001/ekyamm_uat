        ...
        <div className="mt-3 lg:mt-0 bg-[#FFFFFF80] rounded-[12px] p-4">
          ...
          <div>
            ...
            <div className="flex gap-2 items-center">
              ...
              >
                <SelectTrigger
                  className="w-full bg-white rounded-[7.26px] text-[15px] text-black font-medium h-[39px] px-3"
                >
                  <SelectValue placeholder="Choose Relation" />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="Dr.">Choose Relation</SelectItem>
           ...
           <div>
            ...
            />
            {touched.lastName && !formData.firstName && (
              <span className="text-red-500 text-sm mt-1 block">
                First Name is required
              </span>
            )}
