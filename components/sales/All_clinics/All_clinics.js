                ...
                <div className="flex flex-col space-y-4">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex flex-col space-y-1 text-sm">
                      ...
                      <span className="flex items-center text-gray-500">
                        <Phone className="w-4 h-4 mr-1" /> 9406553565 (Primary)
                      </span>
                      <span className="flex items-center text-gray-500">
                        <svg
                      ...
                      <span className="flex items-center text-gray-500">
                        <Mail className="w-4 h-4 mr-1" /> tarun50sahu@gmail.com
                        (Primary)
                      </span>
                      <span className="flex items-center text-gray-500">
                        <Mail className="w-4 h-4 mr-1" /> tarun50sahu@gmail.com
                      ...
                      <span className="text-gray-700 font-medium">
                        <b>Date of Birth - </b>
                        <span className="font-normal">Not added</span>
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="text-sm">
                    ...
                    <div className="flex items-center text-gray-500">
                      <Phone className="w-4 h-4 mr-1" /> 9406553565
                    </div>
                  </div>
                  ...
                  <div className="text-sm">
                    ...
                    <div className="flex items-center text-gray-500">
                      <MapPin className="w-4 h-4 mr-1" /> Diamond Paradise,
                      Darjiling, West Bengal - 734101
                    </div>
                  </div>
                </div>
              </DialogContent>
