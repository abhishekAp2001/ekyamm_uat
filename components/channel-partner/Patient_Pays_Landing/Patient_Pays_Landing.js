  ...
  return (
    <div className="min-h-screen bg-white relative overflow-hidden">
      ...
      <Image
        ...
        width={100}
        height={100}
        className="m-[312px]:w-[312px] min-[358px]:w-[314px] min-[389px]:w-full  md:w-[358px] h-auto mix-blend-multiply absolute bottom-0 right-0"
        alt="ekyamm"
      />
      <div className="container mx-auto px-3 py-8 relative z-10">
              ...
              <div className="flex flex-col">
                <div className="">
                  ...
                  <strong className="text-[34px] text-[#CC627B] font-bold leading-[34px]">
                      Mind
                    <strong className="text-[34px] text-[#776EA5] font-bold px-[10px]">
                      &
                    </strong>
                    Body
                    </strong>
                  ...
                  <strong className="text-[34px] text-[#776EA5] font-bold leading-[34px] ps-[10px]">
                  for Better Fertility
                  </strong>
                </div>
              </div>
              <div className="w-[290px] md:w-[494px] text-black">
            ...
            <div className="space-y-6 fixed bottom-[48px]">
              <div className="space-y-2">
                {/* <h2 className="text-[20px] font-bold text-[#776EA5] leading-6">
                 ...
                 <h2 className="text-[18px] font-bold text-[#776EA5] leading-6 w-[178px] md:w-[400px]">
