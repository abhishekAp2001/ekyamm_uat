...
const Profile = ({
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-t from-[#fce8e5] to-[#eeecfb]  max-w-[576px] mx-auto fixed left-0 right-0 h-screen">
      ...
      {doc ? (
        <>
          <div className="flex-1 pt-[116px] pb-[90px] w-full overflow-auto px-4" style={{
...
linear-gradient(0deg, rgba(255, 255, 255, 0.5), rgba(255, 255, 255, 0.5))` }}>
            ...
            /> */}
              ...
              <div className="mt-4 flex flex-col gap-4 w-full">
                ...
                <Button
                  disabled = {doc?.practiceDetails?.medicalAssociations && doc.practiceDetails?.medicalAssociations.length > 0 ? false : true}
                  onClick={() => {
                ...
                <Button
                disabled = {doc?.testimonials && doc.testimonials.length > 0 ? false : true}
                  onClick={() => {
